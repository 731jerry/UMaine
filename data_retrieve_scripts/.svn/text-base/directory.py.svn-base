...
for myName in names:
    ...
    # <option value="UM" >UMaine only</option>
    # <option value="USM" >USM only</option>
    # <option value="UMA" >UMA only</option>
    # <option value="UMF" >UMF only</option>
    # <option value="UMFK" >UMFK only</option>
    # <option value="UMM" >UMM only</option>
    # <option value="UMPI" >UMPI only</option>
    # <option value="UMS" >UMS only</option>

    br.find_control("campus").value = ["UMS"]
