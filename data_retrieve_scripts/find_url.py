...
UM   = 'http://www.umaine.edu'
UMA  = 'http://www.uma.edu'
UMF  = 'http://www.umf.maine.edu'
UMFK = 'http://www.umfk.maine.edu'
UMM  = 'http://www.umm.maine.edu'
UMPI = 'http://www.umpi.edu'
USM  = 'http://www.usm.maine.edu'
